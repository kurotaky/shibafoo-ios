...
class MyFooViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "CustomPostCell") as? MyFooPostCell
    ...
    func reloadPosts() {
        ...
        if let token = userDefault.object(forKey: "authentication_token") as? String {
            if let email = userDefault.object(forKey: "email") as? String {
                ...
                Alamofire.request(EndpointConst().URL + "api/posts/myself", parameters: parameters).responseJSON { response in
    ...
    @IBAction func loveButtonDidPush(_ sender: UIButton) {
        ...
        let cell = view.superview as! MyFooPostCell
